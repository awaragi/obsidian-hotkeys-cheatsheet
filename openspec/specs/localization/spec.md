...
Detects the active Obsidian locale, resolves translated strings with per-key English fallback, provides locale-aware string comparison, and exposes RTL/LTR direction for layout — shared by the modal and both export capabilities.
